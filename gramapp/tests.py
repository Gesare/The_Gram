...
class TestPost(TestCase):
    def setUp(self):
        self.profile_test = Profile(name='Gesare', user=User(username='ombati'))
        self.profile_test.save()

        self.image_test = Post(image='image.jpg', name='test', caption='default test', user=self.profile_test)
